...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('chat_conversation', (
        ...
        db.send_create_signal('chat', ['Conversation'])

        # Adding model 'Comments'
        db.create_table('chat_comments', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('body', self.gf('django.db.models.fields.TextField')()),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('conversation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['chat.Conversation'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal('chat', ['Comments'])


    def backwards(self, orm):
        # Deleting model 'Conversation'
        db.delete_table('chat_conversation')

        # Deleting model 'Comments'
        db.delete_table('chat_comments')
    ...
    models = {
        ...
        'chat.comments': {
            ...
            'conversation': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['chat.Conversation']"}),
